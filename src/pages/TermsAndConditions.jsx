          ...
          <div className="text-center w-full">
            <div className="p-5 max-w-3xl mx-auto text-left">
              <section className="mb-5">
                <h1 className="text-4xl mb-4">Terms and Conditions</h1>
                <p className="mb-2">Last updated: October 7, 2024</p>
                <p className="mb-2">
                  Welcome to Seccouncil! These Terms and Conditions outline the rules and regulations for the use of Seccouncil's website and services. By accessing or using our website and services, you agree to be bound by these Terms and Conditions. Please read them carefully.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">1. Acceptance of Terms</h2>
                <p className="mb-2">
                  By using our website, enrolling in our training programs, or using our job placement and consultancy services, you agree to comply with and be bound by these Terms and Conditions, along with our Privacy Policy. If you do not agree with any part of these terms, you are prohibited from using or accessing our website and services.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">2. Services</h2>
                <p className="mb-2">Seccouncil provides:</p>
                <ul className="list-disc ml-5 mb-4">
                  <li>Cybersecurity training programs with job placement support.</li>
                  <li>Consultancy services related to cybersecurity and IT.</li>
                  <li>Other services as listed on our website.</li>
                </ul>
                <p>
                  We reserve the right to modify or discontinue our services at any time without prior notice.
                </p>
              ...
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">3. Eligibility</h2>
                <p className="mb-2">To access our services:</p>
                <ul className="list-disc ml-5 mb-4">
                  <li>You must be at least 18 years old or have parental consent.</li>
                  <li>You must provide accurate and complete information when registering for our programs or services.</li>
                </ul>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">4. User Obligations</h2>
                <p className="mb-2">
                  When using our website and services, you agree that you will not:
                </p>
                <ul className="list-disc ml-5 mb-4">
                  <li>Use the website or services for any illegal or unauthorized purpose.</li>
                  <li>Share, distribute, or misuse any content or materials provided by Seccouncil, including training resources, without permission.</li>
                  <li>Interfere with or disrupt the website’s functionality or servers.</li>
                </ul>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">5. Enrollment and Payment</h2>
                <p className="mb-2">
                  By enrolling in our training programs, you agree to:
                </p>
                <ul className="list-disc ml-5 mb-4">
                  <li>Pay any applicable fees as listed on the website for the selected courses or consultancy services.</li>
                  <li>Follow the course requirements, including attendance and assessments.</li>
                  <li>Payments must be made through the methods specified on our website. Fees are non-refundable unless otherwise specified by our refund policy.</li>
                </ul>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">6. Job Placement Services</h2>
                <p className="mb-2">
                  Our job placement services aim to support you in securing employment after completing a training program. However:
                </p>
                <ul className="list-disc ml-5 mb-4">
                  <li>We do not guarantee job placement or employment.</li>
                  <li>The success of job placement depends on various factors, including the candidate’s performance, skills, and job market conditions.</li>
                </ul>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">7. Consultancy Services</h2>
                <p className="mb-2">For consultancy services:</p>
                <ul className="list-disc ml-5 mb-4">
                  <li>We provide recommendations and advice based on our expertise.</li>
                  <li>While we strive to provide accurate and up-to-date information, the final decision and responsibility lie with the client.</li>
                </ul>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">8. Intellectual Property</h2>
                <p className="mb-2">
                  All content and materials available on the Seccouncil website, including but not limited to text, graphics, logos, videos, and software, are the intellectual property of Seccouncil or its licensors and are protected by copyright and trademark laws.
                </p>
                <p className="mb-2">
              ...
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">9. Limitation of Liability</h2>
                <p className="mb-2">
                  To the fullest extent permitted by law:
                </p>
                <p className="mb-2">
                  Seccouncil will not be liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use our website, services, or reliance on the information provided. We do not guarantee that the website will be free from errors or interruptions.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">10. Indemnification</h2>
                <p className="mb-2">
                  You agree to indemnify, defend, and hold harmless Seccouncil and its affiliates from any claims, liabilities, damages, losses, or expenses arising from your use of the website, violation of these terms, or infringement of any third-party rights.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">11. Third-Party Links</h2>
                <p className="mb-2">
                  Our website may contain links to third-party websites. These links are provided for your convenience, but we do not endorse or take responsibility for the content or practices of any third-party websites.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">12. Termination</h2>
                <p className="mb-2">
                  We reserve the right to terminate or suspend your access to our website and services at any time, without notice, for any reason, including if we believe you have violated these Terms and Conditions.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">13. Governing Law</h2>
                <p className="mb-2">
                  These Terms and Conditions are governed by and construed in accordance with the laws of [Your Jurisdiction], without regard to conflict of law principles.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">14. Changes to Terms</h2>
                <p className="mb-2">
                  Seccouncil reserves the right to update or modify these Terms and Conditions at any time. Any changes will be posted on this page, and your continued use of our services after any changes indicates your acceptance of the new terms.
                </p>
              </section>
              <section className="mb-5">
                <h2 className="text-2xl mt-5 mb-2">15. Contact Us</h2>
                <p className="mb-2">If you have any questions or concerns about these Terms and Conditions, please contact us at:</p>
                <p className="mb-2">Seccouncil</p>
                <p className="mb-2">[Insert Company Address]</p>
