  ...
  return (
    ...
    >
      <label className="w-full" style={{position:"relative"}}>
        ...
        <SiGmail style={{color:"black",position:"absolute",top:"calc(49%)",left:"1.65%",fontSize:"20px"}}/>
        <input
          required
          type="text"
          name="email"
      ...
      <FaLock style={{color:"black",position:"absolute",top:"calc(42%)",left:"1.65%",fontSize:"20px"}}/>
        <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-black-5">
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] pr-12 text-black-5"
        />
        <span
